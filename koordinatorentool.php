...
<html>
    <head>
        ...
        <script src="./azubi.js" type="text/javascript"></script>
        <script src="./tableLoad.js" type="text/javascript"></script>
    </head>
    <!-- <script>
            ...
            <div class="Banner">
                <div class="BannerContent">
                    ...
                    <div class="Navigation">
                        <h5 id="Title">Koordinatoren Tool</h5>
                        <a id="HomeLink" href="http://localhost/PHPWorkspaceVSCode/index.html">Home</a>
                    </div>
                </div>
            </div>
